...
from keras.layers import Input, Dense, Convolution2D,Bidirectional, concatenate, Concatenate
...
def AV_model(people_num=2):
    ...
    # print('AVfusion_concat:', AVfusion.shape)
    ...
    audio_output = Reshape((int_shape(audio_input)[1], int_shape(audio_input)[2], int_shape(audio_input)[3], 1))(audio_input)

    # print('complex_mask_out:', complex_mask_out.shape)
    # print('audio_input_expanded:', audio_output.shape)
    output = concatenate([complex_mask_out, audio_output])
    # print('output:', output.shape)
    # AV_model = Model(inputs=[audio_input, video_input], outputs=complex_mask_out)
    AV_model = Model(inputs=[audio_input, video_input], outputs=output)
